...
public class GameWeRide extends GameState
   ...
   public void setBeat() {      //떨어지는 beat 하나하나 설정
      ...
      beats = new Beat[] {
            ...
            new Beat(startTime + gap * 19, 2), // 이거 할때 coin인 경우는 position 앞에 true만 써주면 됩니다.
            ...
            new Beat(startTime + gap * 33, true, 5), // 사과 톡톡톡 
   ...
   public void run() {
      ...
      // 악보가 끝날 때까지 run
      while(gameMusic.getTime() <= 50999 && failure == false && !game.isInterrupted()) {      //노래시간남음 && 받기성공 -> 게임 계속 진행
